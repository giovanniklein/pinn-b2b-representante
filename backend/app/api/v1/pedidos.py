...
async def obter_pedido(
    ...
    return PedidoDetailResponse(
        ...
        cliente_email=cliente_doc.get("email"),
        cliente_email_notas=cliente_doc.get("email_notas"),
        cliente_nome_contato=cliente_doc.get("nome_contato"),
        cliente_telefone=cliente_doc.get("telefone"),
        cliente_celular=cliente_doc.get("celular"),
